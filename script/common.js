...
if (debug) {
    //测试地址
    common_url = 'http://192.168.0.103:9090';
    static_url = 'http://192.168.0.103:9090/lbk/api/file/download/';
} else {
    //正式地址
    common_url = 'http://120.26.74.127:9001';
    static_url = 'http://120.26.74.127:9001/lbk/api/file/download/';
}
//ajax重写
